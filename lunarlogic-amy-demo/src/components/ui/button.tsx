...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[#3B82F6] text-white hover:bg-[#3B82F6]/90 shadow-sm shadow-blue-500/20",
        gradient:
          "brand-gradient-surface text-white hover:opacity-90 shadow-sm shadow-indigo-500/20",
        outline:
          "border border-slate-700 bg-transparent text-slate-300 hover:bg-slate-800/60 hover:text-slate-100",
        ghost: "text-slate-300 hover:bg-slate-800/60 hover:text-slate-100",
        destructive: "bg-red-400 text-white hover:bg-red-400/90",
      },
      size: {
