...
const CLIENTS = {
  ...
  forvismazars: {
    ...
    invoices: [
      ...
      { id: 'FM-4421', customer: 'Alderton Capital Partners',    amount: 162000, due: '2026-07-11', issued: '2026-06-11', status: 'Sent',    daysOut:  0, daysOverdue:   0 },
      { id: 'FM-4420', customer: 'Harborside Technology Corp',   amount:  96000, due: '2026-07-10', issued: '2026-06-10', status: 'Sent',    daysOut:  1, daysOverdue:   0 },
      { id: 'FM-4419', customer: 'Summit Ridge Logistics',       amount:  51000, due: '2026-07-05', issued: '2026-06-05', status: 'Viewed',  daysOut:  6, daysOverdue:   0 },
      // May–Jun 2026 invoices — recalculated as of Jun 11
      { id: 'FM-4418', customer: 'Alderton Capital Partners',    amount: 142000, due: '2026-06-05', issued: '2026-05-06', status: 'Overdue', daysOut: 36, daysOverdue:   6 },
      { id: 'FM-4417', customer: 'Meridian Industrial Group',    amount:  98400, due: '2026-05-10', issued: '2026-04-10', status: 'Overdue', daysOut: 62, daysOverdue:  32 },
      { id: 'FM-4416', customer: 'Castlebrook Real Estate',      amount:  74600, due: '2026-04-14', issued: '2026-03-15', status: 'Overdue', daysOut: 88, daysOverdue:  58 },
      { id: 'FM-4415', customer: 'Vantage Healthcare Systems',   amount: 118000, due: '2026-04-27', issued: '2026-03-28', status: 'Overdue', daysOut: 75, daysOverdue:  45 },
      { id: 'FM-4414', customer: 'Northlake Private Equity',     amount:  56200, due: '2026-05-31', issued: '2026-05-01', status: 'Overdue', daysOut: 41, daysOverdue:  11 },
      { id: 'FM-4413', customer: 'Harborside Technology Corp',   amount:  88000, due: '2026-05-22', issued: '2026-04-22', status: 'Overdue', daysOut: 50, daysOverdue:  20 },
      { id: 'FM-4412', customer: 'Meridian Industrial Group',    amount:  76000, due: '2026-05-03', issued: '2026-04-03', status: 'Overdue', daysOut: 69, daysOverdue:  39 },
      ...
      { id: 'FM-4410', customer: 'Castlebrook Real Estate',      amount:  62400, due: '2026-03-20', issued: '2026-02-18', status: 'Overdue', daysOut:113, daysOverdue:  83 },
      { id: 'FM-4409', customer: 'Vantage Healthcare Systems',   amount:  94000, due: '2026-04-09', issued: '2026-03-10', status: 'Overdue', daysOut: 93, daysOverdue:  63 },
      ...
      { id: 'FM-4407', customer: 'Harborside Technology Corp',   amount:  72000, due: '2026-06-08', issued: '2026-05-09', status: 'Overdue', daysOut: 33, daysOverdue:   3 },
      { id: 'FM-4406', customer: 'Alderton Capital Partners',    amount: 128000, due: '2026-06-06', issued: '2026-05-07', status: 'Overdue', daysOut: 35, daysOverdue:   5 },
      { id: 'FM-4405', customer: 'Lakewood Manufacturing',       amount:  54000, due: '2026-05-29', issued: '2026-04-29', status: 'Overdue', daysOut: 43, daysOverdue:  13 },
      { id: 'FM-4404', customer: 'Meridian Industrial Group',    amount:  82000, due: '2026-05-08', issued: '2026-04-08', status: 'Overdue', daysOut: 64, daysOverdue:  34 },
      { id: 'FM-4403', customer: 'Summit Ridge Logistics',       amount:  44000, due: '2026-05-15', issued: '2026-04-15', status: 'Overdue', daysOut: 57, daysOverdue:  27 },
      { id: 'FM-4402', customer: 'Castlebrook Real Estate',      amount:  68000, due: '2026-06-01', issued: '2026-05-02', status: 'Overdue', daysOut: 40, daysOverdue:  10 },
      { id: 'FM-4401', customer: 'Vantage Healthcare Systems',   amount: 106000, due: '2026-04-20', issued: '2026-03-21', status: 'Overdue', daysOut: 82, daysOverdue:  52 },
      { id: 'FM-4400', customer: 'Castlebrook Real Estate',      amount:  18000, due: '2026-02-12', issued: '2026-01-13', status: 'Overdue', daysOut:149, daysOverdue: 119 },
      { id: 'FM-4399', customer: 'Vantage Healthcare Systems',   amount:  16000, due: '2026-02-05', issued: '2026-01-06', status: 'Overdue', daysOut:156, daysOverdue: 126 },
      { id: 'FM-4398', customer: 'Meridian Industrial Group',    amount:  15000, due: '2026-01-28', issued: '2025-12-29', status: 'Overdue', daysOut:164, daysOverdue: 134 },
      { id: 'FM-4397', customer: 'Castlebrook Real Estate',      amount:  13000, due: '2026-01-15', issued: '2025-12-16', status: 'Overdue', daysOut:177, daysOverdue: 147 },
    ],
    paymentBehavior: [
  ...
  meridian: {
    ...
    invoices: [
      { id: 'MA-3041', customer: 'Bellwether Capital Group',   amount:  42000, due: '2026-07-11', issued: '2026-06-11', status: 'Sent',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3040', customer: 'Crestline Partners LLC',     amount:  28500, due: '2026-07-08', issued: '2026-06-08', status: 'Sent',    daysOut:  3, daysOverdue:   0 },
      { id: 'MA-3039', customer: 'Irongate Solutions Inc',     amount:  19800, due: '2026-07-02', issued: '2026-06-02', status: 'Viewed',  daysOut:  9, daysOverdue:   0 },
      { id: 'MA-3038', customer: 'Parkside Ventures',          amount:  34200, due: '2026-06-25', issued: '2026-05-26', status: 'Viewed',  daysOut: 16, daysOverdue:   0 },
      { id: 'MA-3037', customer: 'Bellwether Capital Group',   amount:  38000, due: '2026-06-10', issued: '2026-05-11', status: 'Overdue', daysOut: 31, daysOverdue:   1 },
      { id: 'MA-3036', customer: 'Thornfield Advisory',        amount:  22400, due: '2026-06-04', issued: '2026-05-05', status: 'Overdue', daysOut: 37, daysOverdue:   7 },
      { id: 'MA-3035', customer: 'Crestline Partners LLC',     amount:  31600, due: '2026-05-28', issued: '2026-04-28', status: 'Overdue', daysOut: 44, daysOverdue:  14 },
      { id: 'MA-3034', customer: 'Waypoint Group',             amount:  16800, due: '2026-05-15', issued: '2026-04-15', status: 'Overdue', daysOut: 57, daysOverdue:  27 },
      { id: 'MA-3033', customer: 'Irongate Solutions Inc',     amount:  24600, due: '2026-05-08', issued: '2026-04-08', status: 'Overdue', daysOut: 64, daysOverdue:  34 },
      { id: 'MA-3032', customer: 'Harrow Consulting Group',    amount:  18200, due: '2026-04-25', issued: '2026-03-26', status: 'Overdue', daysOut: 77, daysOverdue:  47 },
      { id: 'MA-3031', customer: 'Thornfield Advisory',        amount:  15400, due: '2026-04-12', issued: '2026-03-13', status: 'Overdue', daysOut: 90, daysOverdue:  60 },
      { id: 'MA-3030', customer: 'Parkside Ventures',          amount:  27000, due: '2026-05-22', issued: '2026-04-22', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3029', customer: 'Bellwether Capital Group',   amount:  35000, due: '2026-05-05', issued: '2026-04-05', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3028', customer: 'Crestline Partners LLC',     amount:  26400, due: '2026-04-30', issued: '2026-03-31', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3027', customer: 'Waypoint Group',             amount:  14200, due: '2026-05-17', issued: '2026-04-17', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3026', customer: 'Harrow Consulting Group',    amount:  17600, due: '2026-04-20', issued: '2026-03-21', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3025', customer: 'Irongate Solutions Inc',     amount:  21000, due: '2026-04-14', issued: '2026-03-15', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3024', customer: 'Parkside Ventures',          amount:  23800, due: '2026-04-08', issued: '2026-03-09', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3023', customer: 'Thornfield Advisory',        amount:  19400, due: '2026-05-12', issued: '2026-04-12', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
      { id: 'MA-3022', customer: 'Bellwether Capital Group',   amount:  32000, due: '2026-03-28', issued: '2026-02-26', status: 'Paid',    daysOut:  0, daysOverdue:   0 },
    ],
    paymentBehavior: [
