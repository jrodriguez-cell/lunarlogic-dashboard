...
/**
 * Returns invoices expected within `days` days — used by DashboardPage
 * for the "Expected Cash In" stat, keyed off daysOverdue bucket thresholds
 * so it always matches the tile logic in CashFlowForecast.
 *
