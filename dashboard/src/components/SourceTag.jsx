    ...
    <span ref={ref} style={{ position: 'relative', display: 'inline-flex', verticalAlign: 'middle' }}>
      ...
      {open && (
        <div style={{
          ...
          marginBottom: 6, width: 240, background: '#1a2235', border: '1px solid var(--border)',
          borderRadius: 8, padding: '10px 12px', zIndex: 9999, boxShadow: '0 4px 20px rgba(0,0,0,0.4)',
        }}>
